...
+id:01KCA7E8FYRXKH4YRFMW91P2WV

## Summary

An operating system (OS) is system software that manages computer hardware and software resources, and provides common services for computer programs.

[Time-sharing](https://en.wikipedia.org/wiki/Time-sharing) operating systems schedule tasks for efficient use of the system and may also include accounting software for cost allocation of processor time, mass storage, peripherals, and other resources.

For hardware functions such as input and output and memory allocation, the operating system acts as an intermediary between programs and the computer hardware, although the application code is usually executed directly by the hardware and frequently makes system calls to an OS function or is interrupted by it. Operating systems are found on many devices that contain a computer – from cellular phones and video game consoles to web servers and supercomputers.

As of October 2025, Android is the most popular operating system with a 38% market share, followed by [Microsoft](https://en.wikipedia.org/wiki/Microsoft) [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) at 31%, iOS and iPadOS at 15%, macOS at 7%, and [Linux](https://en.wikipedia.org/wiki/Linux) at 1%. Android, iOS, and iPadOS are operating systems for mobile devices such as smartphones, while [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows), macOS, and [Linux](https://en.wikipedia.org/wiki/Linux) are for desktop computers. [Linux](https://en.wikipedia.org/wiki/Linux) distributions are dominant in the server and supercomputing sectors. Other specialized classes of operating systems (special-purpose operating systems), such as embedded and real-time systems, exist for many applications. Security-focused operating systems also exist. Some operating systems have low system requirements (e.g. light-weight [Linux](https://en.wikipedia.org/wiki/Linux) distribution). Others may have higher system requirements.
...
### [Distributed system](https://en.wikipedia.org/wiki/Distributed_computing)s
...
[Embedded operating system](https://en.wikipedia.org/wiki/Embedded_operating_system)s are designed to be used in embedded computer systems, whether they are internet of things objects or not connected to a network. [Embedded system](https://en.wikipedia.org/wiki/Embedded_system)s include many household appliances. The distinguishing factor is that they do not load user-installed software. Consequently, they do not need protection between different applications, enabling simpler designs. Very small operating systems might run in less than 10 kilobytes, and the smallest are for smart cards. Examples include [Embedded [Linux](https://en.wikipedia.org/wiki/Linux)](https://en.wikipedia.org/wiki/[Linux](https://en.wikipedia.org/wiki/Linux)_on_embedded_systems), QNX, VxWorks, and the extra-small systems RIOT and [TinyOS](https://en.wikipedia.org/wiki/TinyOS).
...
A hypervisor is an operating system that runs a virtual machine. The virtual machine is an application that emulates hardware; in other words, it operates as much as possible like the actual hardware the operating system was designed to run on. [Virtual machine](https://en.wikipedia.org/wiki/Virtual_machine)s can be paused, saved, and resumed, making them useful for operating systems research, development, and debugging. They also enhance portability by enabling applications to be run on a computer even if they are not compatible with the base operating system.
...
in a way similarly to embedded and real-time OSes. Note that this overhead is not negligible: to the direct cost of mode switching it's necessary to add the indirect pollution of important processor structures (like [CPU cache](https://en.wikipedia.org/wiki/CPU_cache)s, the instruction pipeline, and so on) which affects both user-mode and kernel-mode performance.

## History

The first computers in the late 1940s and 1950s were directly programmed either with plugboards or with machine code inputted on media such as punch cards, without programming languages or operating systems. After the introduction of the transistor in the mid-1950s, mainframes began to be built. These still needed professional operators who manually do what a modern operating system would do, such as scheduling programs to run, but mainframes still had rudimentary operating systems such as [Fortran Monitor System](https://en.wikipedia.org/wiki/History_of_[IBM](https://en.wikipedia.org/wiki/IBM)_mainframe_operating_systems) (FMS) and IBSYS. In the 1960s, [IBM](https://en.wikipedia.org/wiki/IBM) introduced the first series of intercompatible computers (System/360). All of them ran the same operating system—OS/360—which consisted of millions of lines of assembly language that had thousands of bugs. The OS/360 also was the first popular operating system to support multiprogramming, such that the CPU could be put to use on one job while another was waiting on input/output (I/O). Holding multiple jobs in memory necessitated memory partitioning and safeguards against one job accessing the memory allocated to a different one.

Around the same time, teleprinters began to be used as terminals so multiple users could access the computer simultaneously. The operating system [MULTICS](https://en.wikipedia.org/wiki/Multics) was intended to allow hundreds of users to access a large computer. Despite its limited adoption, it can be considered the precursor to cloud computing. The UNIX operating system originated as a development of [MULTICS](https://en.wikipedia.org/wiki/Multics) for a single user. Because UNIX's source code was available, it became the basis of other, incompatible operating systems, of which the most successful were [AT&T](https://en.wikipedia.org/wiki/AT%26T)'s System V and the University of California's [Berkeley Software Distribution](https://en.wikipedia.org/wiki/Berkeley_Software_Distribution) ([BSD](https://en.wikipedia.org/wiki/Berkeley_Software_Distribution)). To increase compatibility, the IEEE released the POSIX standard for operating system application programming interfaces ([API](https://en.wikipedia.org/wiki/API)s), which is supported by most UNIX systems. [MINIX](https://en.wikipedia.org/wiki/Minix) was a stripped-down version of UNIX, developed in 1987 for educational uses, that inspired the commercially available, free software [Linux](https://en.wikipedia.org/wiki/Linux). Since 2008, [MINIX](https://en.wikipedia.org/wiki/Minix) is used in controllers of most Intel microchips, while [Linux](https://en.wikipedia.org/wiki/Linux) is widespread in data centers and Android smartphones.

### Microcomputers

The invention of large scale integration enabled the production of personal computers (initially called microcomputers) from around 1980. For around five years, the [CP/M](https://en.wikipedia.org/wiki/CP/M) (Control Program for Microcomputers) was the most popular operating system for microcomputers. Later, [IBM](https://en.wikipedia.org/wiki/IBM) bought a disk operating system from [Microsoft](https://en.wikipedia.org/wiki/Microsoft), which [IBM](https://en.wikipedia.org/wiki/IBM) sold as [IBM](https://en.wikipedia.org/wiki/IBM) PC DOS and [Microsoft](https://en.wikipedia.org/wiki/Microsoft) branded as MS-DOS (MicroSoft [Disk Operating System](https://en.wikipedia.org/wiki/Disk_operating_system)) and was widely used on [[IBM](https://en.wikipedia.org/wiki/IBM) PC compatible](https://en.wikipedia.org/wiki/[IBM](https://en.wikipedia.org/wiki/IBM)_PC_compatible) microcomputers. Later versions increased their sophistication, in part by borrowing features from UNIX.

Apple's Macintosh was the first popular computer to use a graphical user interface (GUI). The GUI proved much more user friendly than the text-only command-line interface earlier operating systems had used. Following the success of Macintosh, MS-DOS was updated with a GUI overlay called [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows). [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) later was rewritten as a stand-alone operating system, borrowing so many features from another (VAX VMS) that a large legal settlement was paid. In the twenty-first century, [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) continues to be popular on personal computers but has less market share of servers. UNIX operating systems, especially [Linux](https://en.wikipedia.org/wiki/Linux), are the most popular on enterprise systems and servers but are also used on mobile devices and many other computer systems.

On mobile devices, Symbian OS was dominant at first, being usurped by [BlackBerry OS](https://en.wikipedia.org/wiki/BlackBerry_OS) (introduced 2002) and iOS for iPhones (from 2007). Later on, the open-source Android operating system (introduced 2008), with a [Linux](https://en.wikipedia.org/wiki/Linux) kernel and a C library (Bionic) partially based on [BSD](https://en.wikipedia.org/wiki/Berkeley_Software_Distribution) code, became most popular.
...
Users can send messages to the kernel to modify the behavior of a currently running process. For example, in the command-line environment, pressing the interrupt character (usually [Control-C](https://en.wikipedia.org/wiki/Control-C)) might terminate the currently running process.
...
[Input/output](https://en.wikipedia.org/wiki/Input/output) (I/O) devices are slower than the CPU. Therefore, it would slow down the computer if the CPU had to wait for each I/O to finish. Instead, a computer may implement interrupts for I/O completion, avoiding the need for polling or busy waiting.
...
Memory protection enables the kernel to limit a process' access to the computer's memory. Various methods of memory protection exist, including memory segmentation and paging. All methods require some level of hardware support (such as the [80286](https://en.wikipedia.org/wiki/Intel_80286) MMU), which does not exist in all computers.
...
A modern operating system is usually offers network stack features, for example [TCP/IP](https://en.wikipedia.org/wiki/Internet_protocol_suite) protocol stack.
...
As of October 2025, Android, based on the [Linux](https://en.wikipedia.org/wiki/Linux) kernel, is the most popular operating system with a 38% market share, followed by [Microsoft](https://en.wikipedia.org/wiki/Microsoft) [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) at 31%, iOS and iPadOS at 15%, macOS at 7%, and [Linux](https://en.wikipedia.org/wiki/Linux) at 1%. Android, iOS, and iPadOS are mobile operating systems, while [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows), macOS, and [Linux](https://en.wikipedia.org/wiki/Linux) are desktop operating systems.

### [Linux](https://en.wikipedia.org/wiki/Linux)

[Linux](https://en.wikipedia.org/wiki/Linux) is free software distributed under the [GNU General Public License](https://en.wikipedia.org/wiki/GNU_General_Public_License) (GPL), which means that all of its derivatives are legally required to release their source code. [Linux](https://en.wikipedia.org/wiki/Linux) was designed by programmers for their own use, thus emphasizing simplicity and consistency, with a small number of basic elements that can be combined in nearly unlimited ways, and avoiding redundancy.

Its design is similar to other UNIX systems not using a microkernel. It is written in C and uses UNIX System V syntax, but also supports [BSD](https://en.wikipedia.org/wiki/Berkeley_Software_Distribution) syntax. [Linux](https://en.wikipedia.org/wiki/Linux) supports standard UNIX networking features, as well as the full suite of UNIX tools, while supporting multiple users and employing preemptive multitasking. Initially of a minimalist design, [Linux](https://en.wikipedia.org/wiki/Linux) is a flexible system that can work in under 16 MB of RAM, but still is used on large multiprocessor systems. Similar to other UNIX systems, [Linux](https://en.wikipedia.org/wiki/Linux) distributions are composed of a kernel, system libraries, and system utilities. [Linux](https://en.wikipedia.org/wiki/Linux) has a graphical user interface (GUI) with a desktop, folder and file icons, as well as the option to access the operating system via a command line.

Android is a partially open-source operating system closely based on [Linux](https://en.wikipedia.org/wiki/Linux) and has become the most widely used operating system by users, due to its popularity on smartphones and, to a lesser extent, embedded systems needing a GUI, such as "smart watches, automotive dashboards, airplane seatbacks, medical devices, and home appliances". Unlike [Linux](https://en.wikipedia.org/wiki/Linux), much of Android is written in Java and uses object-oriented design.

### [Microsoft](https://en.wikipedia.org/wiki/Microsoft) [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows)

[Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) is a proprietary operating system that is widely used on desktop computers, laptops, tablets, phones, workstations, enterprise servers, and Xbox consoles. The operating system was designed for "security, reliability, compatibility, high performance, extensibility, portability, and international support"—later on, energy efficiency and support for dynamic devices also became priorities.

[[Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) Executive](https://en.wikipedia.org/wiki/Architecture_of_[Windows](https://en.wikipedia.org/wiki/Microsoft_Windows)_NT) works via kernel-mode objects for important data structures like processes, threads, and sections (memory objects, for example files). The operating system supports demand paging of virtual memory, which speeds up I/O for many applications. I/O device drivers use the [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) Driver Model. The NTFS file system has a master table and each file is represented as a record with metadata. The scheduling includes preemptive multitasking. [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) has many security features; especially important are the use of access-control lists and integrity levels. Every process has an authentication token and each object is given a security descriptor. Later releases have added even more security features.
...
- https://www.oreilly.com/library/view/operating-system-concepts/9780471694663/pt07.html
- https://www.acs.eonerc.rwth-aachen.de/cms/E-ON-ERC-ACS/Studium/Lehrveranstaltungen/~lrhs/Spezial-Betriebssysteme/?lidx=1
- https://www.plantation-productions.com/Webster/www.artofasm.com/DOS/ch17/CH17-1.html#HEADING1-0
- https://archive.org/details/structuredcomput00tane/page/308
- https://www.intel.com/content/dam/www/public/us/en/documents/manuals/64-ia-32-architectures-software-developer-instruction-set-reference-manual-325383.pdf
- https://archive.org/details/structuredcomput00tane/page/292
